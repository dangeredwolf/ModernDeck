...
class NitroLoad {
    ...
    static goReplace() {
        ...
        protocol.interceptStringProtocol("https", (request, result) => {
            if (request.url === "https://tweetdeck.twitter.com/") {
                ...
                return result(`<html class=scroll-v lang=en-US>
                    <head>
                    <meta charset=utf-8>
                    <script src=${NitroLoad.vendor}></script>
                    <script src=${NitroLoad.bundle}></script>
                    <meta charset="utf-8">
                    <meta content="width=device-width,initial-scale=1,minimum-scale=1,user-scalable=yes" name="viewport"><title>TweetDeck</title><meta content="TweetDeck" name="application-name"><meta content="TweetDeck is your personal browser for staying in touch with what’s happening now." name="description"><meta content="yes" name="apple-mobile-web-app-capable"><meta content="black" name="apple-mobile-web-app-status-bar-style"><script src="//www.google-analytics.com/analytics.js" async=""></script>
                    ...
                    <script type="text/javascript" src="moderndeck://sources/libraries/moduleraid.min.js"></script>
                    ...
                    <script src="moderndeck://sources/libraries/emojipicker.js" type="text/javascript"></script>
                    <style>@font-face{font-family:'MD';font-style:normal;font-weight:400;src:url(moderndeck://sources/fonts/mdvectors.woff2) format('woff2');unicode-range:U+0000-FFFF}
                    ...
                    <link rel="stylesheet" href="moderndeck://sources/cssextensions/dark.css" class="mtd-stylesheet-extension">
                    <meta content="width=device-width,initial-scale=1,minimum-scale=1,user-scalable=yes" name=viewport>
                    <body class=scroll-v>
                        <audio id="update-sound" preload="auto" style="display:none" src="moderndeck://sources/alert_2.mp3"><source src="https://ton.twimg.com/tweetdeck-web/web/assets/sounds/tweet.a0da953980.mp3" type="audio/mp3"><source src="https://ton.twimg.com/tweetdeck-web/web/assets/sounds/tweet.8c519d390a.ogg" type="audio/ogg"></audio>
                        ...
                        <div class=windowcontrols>
                            <div class="windowcontrol min">&#xE15B;</div>
                            <div class="windowcontrol max">&#xE3C6;</div>
                            <div class="windowcontrol close" onclick="window.close();">&#xE5CD;</div>
                        </div>
                        <div class=mtd-app-drag-handle></div>
                    </body>
                </html>`);
            }
    ...
    `<html class=scroll-v lang=en-US>
        ...
        <body class=scroll-v>
            ...
            src=moderndeck://sources/alert_2.mp3 style=display:none></audio>
            <div class="js-app-loading login-container">
                <div class="block txt-center ovl-plain">
                    <div class="ovl-block sign-in">
                        <div class="block txt-center js-signin-ui">
